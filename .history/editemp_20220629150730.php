...
if (empty($getEMP[0]['error'])) {
    ...
    $dob            = date("d/m/Y", strtotime($getEMP[0]['dob']));
                    ...
                    <div class="row row-space">
                        ...
                        <div class="col-2">
                            <div class="input-group">
                                ...
                                <input class="input--style-4" type="text" name="contactno" id="contactno" value="<?php echo ($contactno) ?>"minlength="10" maxlength="10" required>
                            </div>
                        </div>
                    </div>
                    <div class="row row-space">
