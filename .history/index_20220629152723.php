...
<body>
            ...
            <div class="card card-4">
                <div class="card-body">
                    ...
                    <ul>
                        ...
                        <li><a href="employees.html">Search/Delete/edit</a></li>
                    </ul>
                    </br>
    ...
    <script>
        $(function() {
            ...
            // Opens colorbox to the employee edit page, Employee ID is required
        ...
        // Checks assigned pageid to determine the current active tab on the navigation menu
        //Home and edit uses the same page
        if (window.location.hash === '#callEdit') {
            editEmp();
        }
        // Switches active class between home and edit
        function editEmp() {
