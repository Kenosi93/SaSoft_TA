...
<body>
    ...
    <div class="wrapper wrapper--w680">
        <ul>
            ...
            <li><a class="active" href="employees.php">Edit Employee</a></li>
            <li><a href="employees.php">Search Employee</a></li>
        </ul>
        </br>
                ...
                <form method="POST" name="frm_emp" id="frm_emp">
                    ...
                    <div class="row row-space" style="border:1px solid lightgrey ;" id="div_skills_0">
                        ...
                        <div class="col-3 ">
                            ...
                            <div id="BTN_0">
                                <div id="BTN">
                                    <button type="button" id="addField"><i class="fa fa-plus">'fgf'</i></button>
    ...
    <script>
        ...
        var counter = getEMP[0]['skills'].length;
        $(function() {
