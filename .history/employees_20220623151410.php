    ...
    <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
        <div class="wrapper wrapper--w680">
            <ul id="ulid">
                ...
                <li id="liid"><a href="employees.php">Edit Employee</a></li>
...

                        {
                            ...
                            formatter: function(value, row, index) {
                                if (typeof row.employeeID != 'undefined') {
                                    ...
                                    buttons += ' <button align="center" onclick="EditEmployee(\'' + row.employeeID + '\')" title="Delete employee"><span class="fa fa-pencil"></span></button>';

                                    buttons += ' <button align="center" onclick="DeleteEmployee(\'' + row.employeeID + '\')" title="Delete employee"><span class="fa fa-times"></span></button>';
