    ...
    <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
        ...
        <div class="wrapper wrapper--w680">
            <ul id="ulid">
                ...
                <li id="liid"><a class="active" href="addemp.html">Add Employee</a></li>
                        ...
                        <div class="row row-space">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="contactno" id="contactno" minlength="10" maxlength="10" required>
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
                        ...
                        <div class="row row-space">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="number" name="code" id="code" maxlength="4" required>
                                </div>
        ...
        $(function() {
            ...
            $("#addField").on('click', function() {
                if (counter <= 2) {
                    ...
                    $('#removeField').show();
                    $('#BTN').appendTo('#BTN_' + counter); // append the add/remove buttons to the current div
            ...
            $("#removeField").on('click', function() {
                if (counter > 0) {
                    ...
                    if (counter == 0) {
                        //If we only have one skill, hide the remove button
                        $('#removeField').hide();
                    } else {
                        $('#removeField').show();
                    }
