            ...
            <div class="card card-4">
                <div class="card-body">
                    ...
                    <form method="POST" name="frm_emp" id="frm_emp">
                        ...
                        <div class="p-t-15 ">
                            <button class="btn btn--radius-2 btn--blue " type="button" id="btnsubmit" formnovalidate>Submit</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script>
        ...
        $(function() {
            ...
            $('#btnsubmit').click(function() {
                // if (!$('frm_emp')[0].checkValidity()) {
                //     $('frm_emp').find('input[type="submit"]').click();
                //     return false;
                // }
